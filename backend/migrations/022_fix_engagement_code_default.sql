...
ALTER TABLE engagements
    ALTER COLUMN engagement_code SET DEFAULT ('EC-' || lpad(nextval('engagement_code_seq')::text, 4, '0'));

UPDATE engagements
SET engagement_code = 'EC-' || lpad(nextval('engagement_code_seq')::text, 4, '0')
WHERE engagement_code IS NULL OR engagement_code = '';
