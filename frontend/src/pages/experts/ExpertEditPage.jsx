...
const FORM_SECTIONS = [
    {
        ...
        fields: [
            { name: 'expert_id', label: 'Expert ID', type: 'text', gridSpan: 1, disabled: true },
...
/**
 * ExpertEditPage — full-page form for editing an existing expert.
 */
export default function ExpertEditPage() {
    ...
    const handleSubmit = useCallback(
        async (e) => {
            ...
            try {
                ...
                navigate('/', { state: { message: `Expert ${result?.data?.expert_id} updated successfully` } });
            } catch (err) {
        ...
        [formData, validate, navigate, id, selectedFile]
    );
    ...
    const renderField = (field) => {
        ...
        const commonProps = {
            ...
            className: `form-input${hasError ? ' form-input--error' : ''}${field.disabled ? ' disabled' : ''}`,
        };
                    ...
                    <div className="file-upload-wrapper">
                        {selectedFile ? (
                            ...
                            <label className="file-upload-label">
                                ...
                                <span>{formData.profile_pdf_url ? 'Replace Profile PDF / CV' : 'Choose PDF or Word doc'}</span>
                                <input
                                    type="file"
                                    accept=".pdf,.doc,.docx"
