...
import { fetchLeadCandidateById, updateLeadCandidate } from '../../api/leads';
import Loader from '../../components/ui/Loader';

export default function LeadCandidateEdit() {
    const { id } = useParams();
    ...
    useEffect(() => {
        let cancelled = false;
        fetchLeadCandidateById(id).then((row) => {
            if (cancelled) return;
            setForm({
    ...
    async function handleSubmit(e) {
        ...
        setIsSaving(true);
        try {
            await updateLeadCandidate(id, form);
    ...
    return (
        <>
            <div className="page-header">
                <h1 className="page-title">Edit Lead Candidate</h1>
            </div>
            <div className="card">
                    ...
                    <div className="form-section">
                        ...
                        <div className="form-grid">
                            ...
                            <div className="form-field" style={{ gridColumn: 'span 2' }}>
                                <label className="form-label">CV / Resume (max 2MB)</label>
